...
export const projects: { en: Project[]; bn: Project[] } = {
  en: [
    ...
    },
    {
      ...
      description:
        "Leading skill-learning platform in Bangladesh. Built with Next.js and GraphQL, featuring interactive courses, progress tracking, and seamless user experience.",
      tech: ["Next.js", "TypeScript", "GraphQL", "Tailwind CSS"],
    ...
    },
    {
      ...
      description:
        "Specialized learning platforms tailored for university students, offering targeted educational content and resources.",
      tech: ["Next.js", "TypeScript", "GraphQL", "Tailwind CSS"],
      demos: {
    ...
    },
    {
      ...
      description:
        "A showcase of modern web design principles featuring responsive layouts and clean aesthetics.",
    ...
    },
    {
      title: "Natours Tour",
      description:
        "An elegant tour booking website demonstrating advanced CSS and modern design patterns.",
    ...
    },
    {
      ...
      description:
        "Interactive web animations showcase using the GreenSock Animation Platform (GSAP).",
    ...
    },
    {
      ...
      description:
        "A comprehensive financial management application for tracking expenses and managing budgets.",
  ...
  bn: [
    ...
    {
      title: "ক্রাউন ক্লোদিং",
      description: "আধুনিক শপিং অভিজ্ঞতা সহ ফ্যাশন রিটেইলের জন্য ই-কমার্স প্ল্যাটফর্ম।",
      tech: ["React", "Redux", "Firebase", "Styled Components"],
      github: "https://github.com/mdraselswe/crwn-clothing",
    },
  ],
